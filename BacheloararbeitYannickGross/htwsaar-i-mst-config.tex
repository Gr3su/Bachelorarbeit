...
\newenvironment{datatabular}{%
 ...
 \toprule%
 \boldmath $\rho$ & \multicolumn{1}{c}{\bfseries Datensatz} & \multicolumn{1}{c|}{\bfseries Analyseverf.} & \bfseries TP & \bfseries TN & \bfseries FP & \bfseries FN & \bfseries Acc. & \bfseries Prec. \\%
}{%
 \bottomrule%
 \end{tabular}%
}
