...
% ****************************************************************************************************
\newcommand{\myTitle}{Auswirkung der Kompression von Zeitreihendaten \\auf Ähnlichkeitssuche und Ausreißererkennung}
...
\newcommand{\myName}{Yannick Gabriel Groß\xspace}
...
\usepackage{tabularx} % better tables
	\setlength{\extrarowheight}{1pt} % increase table row height
...
\definecolor{stringgreen}{RGB}{0,150,0}
...
\newenvironment{datatabular}{%
 \begin{tabular}{cll|cccccc}%
 \toprule%
 \boldmath $\rho$ & \multicolumn{1}{c}{\bfseries Datensatz} & \multicolumn{1}{c|}{\bfseries Analyseverf.} & \bfseries TP & \bfseries TN & \bfseries FP & \bfseries FN & \bfseries Rec. & \bfseries Prec. \\%
}{%
 \bottomrule%
 \end{tabular}%
}
\newcommand{\datarowfirst}[3]{%
 \midrule%
 \multirow{4}{*}{#1} & \multirow{4}{*}{#2} & #3 &%
}
\newcommand{\datarownext}[1]{& & #1 &}
\newcommand{\datarowright}[6]{\phantom{000}\llap{#1} & \phantom{000}\llap{#2} & \phantom{000}\llap{#3} & \phantom{000}\llap{#4} & #5 & #6 \\}
\newcommand{\tabledata}[4]{\phantom{000}\llap{#1} & \phantom{000}\llap{#2} & \phantom{000}\llap{#3} & \phantom{000}\llap{#4}\\}